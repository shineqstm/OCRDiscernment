...
public class IDCardActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void scanFront() {
        ...
        intent.putExtra(CameraActivity.KEY_OUTPUT_FILE_PATH,
                FileUtils.getSaveFile(getApplication(),CameraActivity.CONTENT_TYPE_ID_CARD_FRONT).getAbsolutePath());
    ...
    private void scanBack() {
        ...
        intent.putExtra(CameraActivity.KEY_OUTPUT_FILE_PATH,
                FileUtils.getSaveFile(getApplication(),CameraActivity.CONTENT_TYPE_ID_CARD_BACK).getAbsolutePath());
            ...
            if (data != null) {
                ...
                if (!TextUtils.isEmpty(contentType)) {
                    ...
                    if (CameraActivity.CONTENT_TYPE_ID_CARD_FRONT.equals(contentType)) {
                        String filePath = FileUtils.getSaveFile(getApplicationContext(),CameraActivity.CONTENT_TYPE_ID_CARD_FRONT).getAbsolutePath();
                        recIDCard(IDCardParams.ID_CARD_SIDE_FRONT, filePath);
                    } else if (CameraActivity.CONTENT_TYPE_ID_CARD_BACK.equals(contentType)) {
                        String filePath = FileUtils.getSaveFile(getApplicationContext(),CameraActivity.CONTENT_TYPE_ID_CARD_BACK).getAbsolutePath();
